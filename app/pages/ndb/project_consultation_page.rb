...
class ProjectConsultationPage < Lol::Page
  ...
  button :save_note, :xpath=> "//div[6]/div[3]/div/button[1]"
  button :complete_save_note, :xpath=> "//button[1]"
  ...
  #update task 
  element :update_task_link, :i ,:xpath=> "//tr/td[20]/div[1]/a[1]/i"
  ...
  element :update_task_link1, :i ,:xpath=> "//tr/td[19]/div/a/i"
  ...
  button :save_consultaion, :name=> "yt0"
  #comlepete task buttn
  button :complete_task_button, :id=> "task-complete-form-btn"
  ...
  #input nick name  
  text_field :nick_name, :xpath=> "//div[2]/span[2]/input"
  #select type of interview
  select_list :type_of_interview, :xpath=> "//div[4]/span[2]/select"
  #click client 
  ...
  #select team skm
  select_list :select_team_skm, :id=> "Team_skm"
  ...
  button :next_step_a, :xpath=> "//form/div/div/div[1]/div[2]/input[1]"
  #input mail to
  ul :input_mail_to ,:xpath=> "//span[2]/div/ul"
  #select email to mail to
  div :select_email ,:text=> "test_km1 [ test_km1@capvision.com.cn ]"
  ...
  #save btn when complete task
  button :save_complete_page_btn1 ,:xpath=> "//form/div[6]/input[1]"
  ...
  #link
  link :task_list_link ,:xpath=> "//div/div/div/div/ul/li[1]/a"
  #upload file
  ...
  #task feedback
  element :task_feedback_link , :i ,:xpath=>"//div[@id='task-grid']/table/tbody/tr/td[20]/div/a[2]/i"
  #expertise
  ...
  #click km note link
  link :km_note_link ,:xpath=> "//div[@id='task-grid']/table/tbody/tr/td[8]/a"
  #input km note 
  ...
  #select project pm
  select_list :select_project_pm, :id=> "ProjectDetailForm_pm"
  #select project skm
  select_list :select_project_skm, :id=> "ProjectDetailForm_skm"
  ...
  def edit_project_info
    ...
    self.select_team_skm_element.when_present.select "Test Skm1"
    self.edit_project_team_element.when_present.click
		self.edit_project_requirements_element.when_present.click
		self.input_info_requirements_element.when_present.clear
		self.input_info_requirements_element.when_present.set "at_test_consultationlol wowawowerjwad@!#!@3  123"
		self.edit_project_requirements_element.when_present.click
  end
  ...
  def project_feedback
	...
	def change_second_task task_status
      ...
      self.change_status_element.when_present.focus
      self.change_status_element.when_present.click
	end
	...
	def change_ca_to_signment
		  self.link_to_compliance_element.when_present.click
      self.client_agreement_element.when_present.click
      self.select_client_agreement_element.when_present.select "test_ca"
      self.save_client_agreement_element.when_present.click
	end
	...
	def send_calendar
      ...
      self.nick_name_element.when_present.append "cenimeiace"
      self.type_of_interview_element.when_present.select "Phone"
      self.next_step_element.when_present.focus
	...
	def send_sms_arrange 
      ...
      if self.second_task_checkbox_element.exist?
        self.second_task_checkbox_element.when_present.click
			...
			#self.consultant_date_element.when_present.clear
      #self.consultant_date_element.when_present.append "23:57"
      self.consultant_date_element.when_present.set "23:57"
      self.nick_name_element.when_present.clear
      self.nick_name_element.when_present.append "cenimeiace"
      self.type_of_interview_element.when_present.select "Phone"
      self.next_step_element.when_present.focus
	...
	def	client_agreement
	    ...
	    self.select_tnc_or_ca_element.when_present.select "test_ca"
	    self.save_tnc_or_ca_element.when_present.click
	end
