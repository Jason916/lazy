...
class ContactPage < Lol::Page
  ...
  #select other industry
  div :select_other_industry ,:text=> "Agriculture - 农业"
  #add other contact
  ...
  #select adept language
  checkbox :select_adept_language ,:id=> "Contact_adeptlanguage_0"
  #select other adept language
  checkbox :select_other_adept_language ,:id=> "Contact_adeptlanguage_1"
  #click more link
  link :click_more_or_packup_link ,:xpath=> "//div/div[2]/div[3]/div/div/div/a"
  ...
  def contact_table_list_status
    self.contact_list_element[self.num.to_i][4].text
  end
